...
const SpacedRepetition = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Header */}
      <div className="bg-gradient-to-br from-purple-500/10 via-blue-500/10 to-cyan-500/10 border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-10">
